...
pub fn render_commit_detail(
        ...
        return v_flex()
            ...
            .child(
                div()
                    .text_xs()
                    .text_color(muted_fg)
                    .child("Select a commit to see changed files"),
            )
            .into_any_element();
    };
    ...
    let files_loading =
        git_manager.selected_commit_files.is_empty() && git_manager.selected_commit.is_some();
    ...
    let content_header_label = git_manager
        .selected_commit_file
        .clone()
