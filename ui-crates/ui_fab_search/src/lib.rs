...
pub(crate) use dispatch::{DownloadState, SortBy, LicenseFilter};
...
use parser::{SketchfabModel, SketchfabModelDetail, SketchfabMe};
        ...
        let body: AnyElement = if self.is_loading {
            ...
            if self.detail_loading {
                ...
                let mut loaded: HashMap<String, std::sync::Arc<gpui::RenderImage>> =
                    detail.all_thumbnail_urls().into_iter().take(12).filter_map(|url| {
