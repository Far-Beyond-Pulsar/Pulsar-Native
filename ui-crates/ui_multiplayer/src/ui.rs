...
impl MultiplayerWindow {
    pub(super) fn render_connection_form(
        &self,
        ...
        v_flex()
            ...
            .child(
                ...
                v_flex()
                    ...
                    .child(TextInput::new(&self.server_address_input)),
            )
            .child(
                ...
                v_flex()
                    ...
                    .child(
                        v_flex()
                            ...
                            .child(TextInput::new(&self.session_id_input)),
                    )
                    .child(
                        v_flex()
                            .gap_2()
                            ...
                            .child(TextInput::new(&self.session_password_input)),
                    )
                    .child(
    ...
    pub(super) fn render_session_info_tab(
        &self,
                ...
                v_flex()
                    ...
                    .child(
                        v_flex()
                            .gap_1()
                            .children(
                                self.format_participants(&session.connected_users)
                                    .iter()
                                    .map(|user| {
                                        h_flex()
                                            .items_center()
    ...
    pub(super) fn render_file_sync_tab(
        &self,
        cx: &mut Context<MultiplayerWindow>,
    ) -> impl IntoElement {
            ...
            return v_flex()
                ...
                .child(
                    ...
                    div()
                        ...
                        .child(format!(
                            "{}%",
                            (self.sync_progress_percent.unwrap_or(0.0) * 100.0) as u32
                        )),
                )
                .into_any_element();
        }
        ...
        if let Some((diff, host_peer_id)) = &self.pending_file_sync {
            ...
            v_flex()
                ...
                .child(
                    ...
                    div().flex_1().child(self.diff_viewer.clone()),
                )
                .into_any_element()
        } else {
    ...
    pub(super) fn render_presence_tab(
        &self,
        cx: &mut Context<MultiplayerWindow>,
    ) -> impl IntoElement {
            ...
            .child(
                ...
                div().flex_1().p_4().child(
                    v_flex()
                        ...
                        .children(self.user_presences.iter().map(|presence| {
    ...
    pub(super) fn render_active_session(
        &self,
        session: &ActiveSession,
        cx: &mut Context<MultiplayerWindow>,
    ) -> impl IntoElement {
