...
impl PropertiesPanel {
    ...
    fn render_toggle_chip(
        ...
        h_flex()
            ...
            .child(ui::Icon::new(icon).size(px(12.0)).text_color(text_color))
            .child(
                div()
                    .text_xs()
                    .font_weight(FontWeight::MEDIUM)
    ...
    fn render_collapsible_section(
        ...
        CollapsibleSection::new(title_str)
            .icon(icon)
            .open(!is_collapsed)
                ...
                div()
                    ...
                    .on_mouse_down(
                        ...
                        cx.listener(move |this, _event, window, cx| {
                            this.start_editing(
                                property_path_owned.clone(),
                                value_str_for_click.clone(),
                                window,
                                cx,
                            );
                        }),
    ...
    fn render_components_section(
        ...
        Self::render_collapsible_section(
            ...
            v_flex()
                .gap_2()
                .child(Self::render_component_item(
                    "Transform",
                    "Built-in",
                    true,
                    cx,
    ...
    fn render_mini_toggle(
        ...
        h_flex()
            ...
            .cursor_pointer()
            .hover(|s| s.opacity(0.8))
            .child(div().size_2().rounded_full().bg(text_color))
            .child(
                div()
                    .text_xs()
                    .text_color(text_color)
