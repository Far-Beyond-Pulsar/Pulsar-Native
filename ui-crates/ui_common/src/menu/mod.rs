    ...
    vec![
            ...
            items: vec![
                ...
                MenuItem::Submenu(Menu {
                    ...
                    items: vec![
                        ...
                        MenuItem::action(
                            t!("Menu.File.ImportFromUnity").to_string(),
                            ImportFromUnity,
                        ),
                        MenuItem::action(
                            t!("Menu.File.ImportFromUnreal").to_string(),
                            ImportFromUnreal,
                        ),
                        MenuItem::action(
                            t!("Menu.File.ImportFromGodot").to_string(),
                            ImportFromGodot,
                        ),
                    ],
                }),
                MenuItem::Submenu(Menu {
                    ...
                    items: vec![
                        ...
                        MenuItem::action(
                            t!("Menu.File.ExportSelected").to_string(),
                            ExportSelected,
                        ),
                        MenuItem::separator(),
            ...
            items: vec![
                ...
                MenuItem::Submenu(Menu {
                    ...
                    items: vec![
                        ...
                        MenuItem::action(
                            t!("Menu.Edit.ReplaceInFiles").to_string(),
                            ReplaceInFiles,
                        ),
                        MenuItem::separator(),
                        MenuItem::action(t!("Menu.Edit.FindUsages").to_string(), FindUsages),
                        MenuItem::action(
                            t!("Menu.Edit.FindImplementations").to_string(),
                            FindImplementations,
                        ),
                    ],
                }),
                ...
                MenuItem::Submenu(Menu {
                    ...
                    items: vec![
                        MenuItem::action(
                            t!("Menu.Edit.FormatDocument").to_string(),
                            FormatDocument,
                        ),
                        MenuItem::action(
                            t!("Menu.Edit.FormatSelection").to_string(),
                            FormatSelection,
                        ),
                        MenuItem::separator(),
                        ...
                        MenuItem::action(
                            t!("Menu.Edit.RemoveDuplicates").to_string(),
                            RemoveDuplicates,
                        ),
                        MenuItem::action(
                            t!("Menu.Edit.TrimWhitespace").to_string(),
                            TrimWhitespace,
                        ),
                    ],
                }),
        ...
        Menu {
            ...
            items: vec![
                ...
                MenuItem::separator(),
                MenuItem::action(
                    t!("Menu.Selection.ExpandSelection").to_string(),
                    ExpandSelection,
                ),
                MenuItem::action(
                    t!("Menu.Selection.ShrinkSelection").to_string(),
                    ShrinkSelection,
                ),
                MenuItem::separator(),
                MenuItem::action(
                    t!("Menu.Selection.AddCursorAbove").to_string(),
                    AddCursorAbove,
                ),
                MenuItem::action(
                    t!("Menu.Selection.AddCursorBelow").to_string(),
                    AddCursorBelow,
                ),
                MenuItem::action(
                    t!("Menu.Selection.AddCursorLineEnds").to_string(),
                    AddCursorLineEnds,
                ),
                MenuItem::separator(),
                MenuItem::action(
                    t!("Menu.Selection.SelectAllOccurrences").to_string(),
                    SelectAllOccurrences,
                ),
                MenuItem::action(
                    t!("Menu.Selection.SelectNextOccurrence").to_string(),
                    SelectNextOccurrence,
                ),
                MenuItem::action(
                    t!("Menu.Selection.SkipOccurrence").to_string(),
                    SkipOccurrence,
                ),
            ],
        },
            ...
            items: vec![
                MenuItem::Submenu(Menu {
                    ...
                    items: vec![
                        ...
                        MenuItem::action(
                            t!("Menu.View.AssetBrowser").to_string(),
                            ToggleAssetBrowser,
                        ),
                        MenuItem::separator(),
                        ...
                        MenuItem::action(
                            t!("Menu.View.MemoryAnalyzer").to_string(),
                            ToggleMemoryAnalyzer,
                        ),
                ...
                MenuItem::Submenu(Menu {
                    ...
                    items: vec![
                        MenuItem::action(
                            t!("Menu.View.SplitHorizontal").to_string(),
                            SplitHorizontal,
                        ),
        ...
        Menu {
            ...
            items: vec![
                ...
                MenuItem::action(
                    t!("Menu.Go.GoToTypeDefinition").to_string(),
                    GoToTypeDefinition,
                ),
                MenuItem::action(
                    t!("Menu.Go.GoToImplementation").to_string(),
                    GoToImplementation,
                ),
        ...
        Menu {
            ...
            items: vec![
                ...
                MenuItem::action(
                    t!("Menu.Project.PackageSettings").to_string(),
                    PackageSettings,
                ),
                MenuItem::separator(),
                MenuItem::Submenu(Menu {
                    ...
                    items: vec![
                        MenuItem::action(
                            t!("Menu.Project.AddDependency").to_string(),
                            AddDependency,
                        ),
                        MenuItem::action(
                            t!("Menu.Project.UpdateDependencies").to_string(),
                            UpdateDependencies,
                        ),
                        MenuItem::action(
                            t!("Menu.Project.RemoveUnused").to_string(),
                            RemoveUnusedDeps,
                        ),
                        MenuItem::separator(),
                        MenuItem::action(
                            t!("Menu.Project.OpenCargoToml").to_string(),
                            OpenCargoToml,
                        ),
                    ],
                }),
            ...
            items: vec![
                ...
                MenuItem::Submenu(Menu {
                    ...
                    items: vec![
                        ...
                        MenuItem::action(t!("Menu.Build.BuildRelease").to_string(), BuildRelease),
                        MenuItem::action(
                            t!("Menu.Build.BuildReleaseDebug").to_string(),
                            BuildReleaseDebug,
                        ),
                        MenuItem::separator(),
                ...
                MenuItem::action(
                    t!("Menu.Build.ShowBuildOutput").to_string(),
                    ShowBuildOutput,
                ),
            ],
        },
            ...
            items: vec![
                ...
                MenuItem::Submenu(Menu {
                    ...
                    items: vec![
                        ...
                        MenuItem::separator(),
                        MenuItem::action(
                            t!("Menu.Run.ToggleBreakpoint").to_string(),
                            ToggleBreakpoint,
                        ),
                        MenuItem::action(
                            t!("Menu.Run.DisableBreakpoints").to_string(),
                            DisableBreakpoints,
                        ),
                        MenuItem::action(
                            t!("Menu.Run.RemoveBreakpoints").to_string(),
                            RemoveBreakpoints,
                        ),
                    ],
                }),
                ...
                MenuItem::Submenu(Menu {
                    ...
                    items: vec![
                        ...
                        MenuItem::action(
                            t!("Menu.Run.CompareBenchmarks").to_string(),
                            CompareBenchmarks,
                        ),
            ...
            items: vec![
                MenuItem::Submenu(Menu {
                    ...
                    items: vec![
                        ...
                        MenuItem::action(
                            t!("Menu.GameEngine.SaveSceneAs").to_string(),
                            SaveSceneAs,
                        ),
                        MenuItem::separator(),
                        ...
                        MenuItem::separator(),
                        MenuItem::action(
                            t!("Menu.GameEngine.SceneSettings").to_string(),
                            SceneSettings,
                        ),
                    ],
                }),
                MenuItem::Submenu(Menu {
                    ...
                    items: vec![
                        MenuItem::action(
                            t!("Menu.GameEngine.CreateEmpty").to_string(),
                            CreateEmpty,
                        ),
                        MenuItem::separator(),
                        MenuItem::Submenu(Menu {
                            ...
                            items: vec![
                                MenuItem::action(
                                    t!("Menu.GameEngine.CreateCube").to_string(),
                                    CreateCube,
                                ),
                                MenuItem::action(
                                    t!("Menu.GameEngine.CreateSphere").to_string(),
                                    CreateSphere,
                                ),
                                MenuItem::action(
                                    t!("Menu.GameEngine.CreateCapsule").to_string(),
                                    CreateCapsule,
                                ),
                                MenuItem::action(
                                    t!("Menu.GameEngine.CreateCylinder").to_string(),
                                    CreateCylinder,
                                ),
                                MenuItem::action(
                                    t!("Menu.GameEngine.CreatePlane").to_string(),
                                    CreatePlane,
                                ),
                                MenuItem::separator(),
                                MenuItem::action(
                                    t!("Menu.GameEngine.CreateTerrain").to_string(),
                                    CreateTerrain,
                                ),
                            ],
                        }),
                        MenuItem::Submenu(Menu {
                            ...
                            items: vec![
                                MenuItem::action(
                                    t!("Menu.GameEngine.CreateSprite").to_string(),
                                    CreateSprite,
                                ),
                                MenuItem::action(
                                    t!("Menu.GameEngine.CreateTilemap").to_string(),
                                    CreateTilemap,
                                ),
                                MenuItem::action(
                                    t!("Menu.GameEngine.CreateParticles2D").to_string(),
                                    CreateParticles2D,
                                ),
                            ],
                        }),
                        MenuItem::Submenu(Menu {
                            ...
                            items: vec![
                                MenuItem::action(
                                    t!("Menu.GameEngine.CreateDirectionalLight").to_string(),
                                    CreateDirectionalLight,
                                ),
                                MenuItem::action(
                                    t!("Menu.GameEngine.CreatePointLight").to_string(),
                                    CreatePointLight,
                                ),
                                MenuItem::action(
                                    t!("Menu.GameEngine.CreateSpotLight").to_string(),
                                    CreateSpotLight,
                                ),
                                MenuItem::action(
                                    t!("Menu.GameEngine.CreateAreaLight").to_string(),
                                    CreateAreaLight,
                                ),
                            ],
                        }),
                        MenuItem::Submenu(Menu {
                            ...
                            items: vec![
                                MenuItem::action(
                                    t!("Menu.GameEngine.CreateAudioSource").to_string(),
                                    CreateAudioSource,
                                ),
                                MenuItem::action(
                                    t!("Menu.GameEngine.CreateAudioListener").to_string(),
                                    CreateAudioListener,
                                ),
                            ],
                        }),
                        MenuItem::Submenu(Menu {
                            ...
                            items: vec![
                                MenuItem::action(
                                    t!("Menu.GameEngine.CreateParticleSystem").to_string(),
                                    CreateParticleSystem,
                                ),
                                MenuItem::action(
                                    t!("Menu.GameEngine.CreateVFX").to_string(),
                                    CreateVFX,
                                ),
                                MenuItem::action(
                                    t!("Menu.GameEngine.CreatePostProcessing").to_string(),
                                    CreatePostProcessing,
                                ),
                            ],
                        }),
                        MenuItem::Submenu(Menu {
                            ...
                            items: vec![
                                MenuItem::action(
                                    t!("Menu.GameEngine.CreateCamera").to_string(),
                                    CreateCamera,
                                ),
                                MenuItem::action(
                                    t!("Menu.GameEngine.CreateOrthoCamera").to_string(),
                                    CreateOrthoCamera,
                                ),
                            ],
                        }),
                        MenuItem::Submenu(Menu {
                            ...
                            items: vec![
                                MenuItem::action(
                                    t!("Menu.GameEngine.CreateCanvas").to_string(),
                                    CreateCanvas,
                                ),
                                MenuItem::action(
                                    t!("Menu.GameEngine.CreatePanel").to_string(),
                                    CreatePanel,
                                ),
                                MenuItem::action(
                                    t!("Menu.GameEngine.CreateButton").to_string(),
                                    CreateButton,
                                ),
                                MenuItem::action(
                                    t!("Menu.GameEngine.CreateText").to_string(),
                                    CreateText,
                                ),
                                MenuItem::action(
                                    t!("Menu.GameEngine.CreateImage").to_string(),
                                    CreateImage,
                                ),
                                MenuItem::action(
                                    t!("Menu.GameEngine.CreateSlider").to_string(),
                                    CreateSlider,
                                ),
                                MenuItem::action(
                                    t!("Menu.GameEngine.CreateInputField").to_string(),
                                    CreateInputField,
                                ),
                            ],
                        }),
                ...
                MenuItem::Submenu(Menu {
                    ...
                    items: vec![
                        MenuItem::action(
                            t!("Menu.GameEngine.AddRigidbody").to_string(),
                            AddRigidbody,
                        ),
                        MenuItem::action(
                            t!("Menu.GameEngine.AddCollider").to_string(),
                            AddCollider,
                        ),
                        MenuItem::action(
                            t!("Menu.GameEngine.AddCharacterController").to_string(),
                            AddCharacterController,
                        ),
                        MenuItem::separator(),
                        MenuItem::action(
                            t!("Menu.GameEngine.PhysicsSettings").to_string(),
                            PhysicsSettings,
                        ),
                        MenuItem::action(
                            t!("Menu.GameEngine.CollisionMatrix").to_string(),
                            CollisionMatrix,
                        ),
                    ],
                }),
                MenuItem::Submenu(Menu {
                    ...
                    items: vec![
                        MenuItem::action(
                            t!("Menu.GameEngine.RenderSettings").to_string(),
                            RenderSettings,
                        ),
                        MenuItem::action(
                            t!("Menu.GameEngine.LightingSettings").to_string(),
                            LightingSettings,
                        ),
                        MenuItem::action(
                            t!("Menu.GameEngine.QualitySettings").to_string(),
                            QualitySettings,
                        ),
                        MenuItem::separator(),
                        MenuItem::action(
                            t!("Menu.GameEngine.BakeLighting").to_string(),
                            BakeLighting,
                        ),
                        MenuItem::action(
                            t!("Menu.GameEngine.ClearBakedData").to_string(),
                            ClearBakedData,
                        ),
                        MenuItem::separator(),
                        MenuItem::action(
                            t!("Menu.GameEngine.FrameDebugger").to_string(),
                            FrameDebugger,
                        ),
                        MenuItem::action(
                            t!("Menu.GameEngine.EngineProfiler").to_string(),
                            EngineProfiler,
                        ),
                    ],
                }),
                MenuItem::separator(),
                MenuItem::action(
                    t!("Menu.GameEngine.PackageManager").to_string(),
                    PackageManager,
                ),
        ...
        Menu {
            ...
            items: vec![
                ...
                MenuItem::Submenu(Menu {
                    ...
                    items: vec![
                        MenuItem::action(
                            t!("Menu.Assets.CreateMaterial").to_string(),
                            CreateMaterial,
                        ),
                        MenuItem::action(t!("Menu.Assets.CreateShader").to_string(), CreateShader),
                        MenuItem::action(
                            t!("Menu.Assets.CreateTexture").to_string(),
                            CreateTexture,
                        ),
                        MenuItem::separator(),
                        MenuItem::action(
                            t!("Menu.Assets.CreateAnimClip").to_string(),
                            CreateAnimClip,
                        ),
                        MenuItem::action(
                            t!("Menu.Assets.CreateAnimController").to_string(),
                            CreateAnimController,
                        ),
                        MenuItem::separator(),
                        MenuItem::action(
                            t!("Menu.Assets.CreateAudioMixer").to_string(),
                            CreateAudioMixer,
                        ),
                        MenuItem::action(
                            t!("Menu.Assets.CreateRenderTexture").to_string(),
                            CreateRenderTexture,
                        ),
                        MenuItem::separator(),
                        MenuItem::action(t!("Menu.Assets.CreatePrefab").to_string(), CreatePrefab),
                        MenuItem::action(
                            t!("Menu.Assets.CreateScriptableObject").to_string(),
                            CreateScriptableObject,
                        ),
                    ],
                }),
                ...
                MenuItem::separator(),
                MenuItem::action(
                    t!("Menu.Assets.FindReferences").to_string(),
                    FindAssetReferences,
                ),
                MenuItem::action(
                    t!("Menu.Assets.FindMissingReferences").to_string(),
                    FindMissingReferences,
                ),
            ],
        },
            ...
            items: vec![
                MenuItem::Submenu(Menu {
                    ...
                    items: vec![
                        ...
                        MenuItem::action(
                            t!("Menu.Tools.GenerateRustAnalyzer").to_string(),
                            GenerateRustAnalyzer,
                        ),
                        MenuItem::separator(),
                        MenuItem::action(t!("Menu.Tools.ExpandMacro").to_string(), ExpandMacro),
                        MenuItem::action(
                            t!("Menu.Tools.ShowSyntaxTree").to_string(),
                            ShowSyntaxTree,
                        ),
                        MenuItem::action(t!("Menu.Tools.ShowHIR").to_string(), ShowHIR),
                        MenuItem::separator(),
                        MenuItem::action(
                            t!("Menu.Tools.InlineVariable").to_string(),
                            InlineVariable,
                        ),
                        MenuItem::action(
                            t!("Menu.Tools.ExtractFunction").to_string(),
                            ExtractFunction,
                        ),
                        MenuItem::action(
                            t!("Menu.Tools.ExtractVariable").to_string(),
                            ExtractVariable,
                        ),
                    ],
                }),
                MenuItem::Submenu(Menu {
                    ...
                    items: vec![
                        ...
                        MenuItem::action(
                            t!("Menu.Tools.ShaderVariants").to_string(),
                            ShaderVariants,
                        ),
                        MenuItem::separator(),
                        MenuItem::action(
                            t!("Menu.Tools.SPIRVDisassembly").to_string(),
                            SPIRVDisassembly,
                        ),
                    ],
                }),
                MenuItem::Submenu(Menu {
                    ...
                    items: vec![
                        MenuItem::action(
                            t!("Menu.Tools.AnimationWindow").to_string(),
                            AnimationWindow,
                        ),
                        MenuItem::action(
                            t!("Menu.Tools.AnimatorWindow").to_string(),
                            AnimatorWindow,
                        ),
                ...
                MenuItem::action(
                    t!("Menu.Tools.AudioMixerWindow").to_string(),
                    AudioMixerWindow,
                ),
                MenuItem::separator(),
