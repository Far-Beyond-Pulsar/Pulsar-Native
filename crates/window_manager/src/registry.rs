...
/// A zero-param window that can register itself in the [`WindowRegistry`].
///
/// Populated at compile time via `inventory::submit!` generated by
/// `#[window_manager::register_window]`. Iterated by `register_all_windows`
/// during app startup — no manual central list needed.
