...
pub fn register(cfg: &'static ConfigManager) {
    let schema = NamespaceSchema::new("Gameplay", "Core gameplay simulation parameters")
        ...
        .setting(
            "default_game_mode",
            SchemaEntry::new(
                "Class name of the default game mode to spawn",
                "DefaultGameMode",
            )
            .label("Default Game Mode")
            .page("Gameplay")
            .field_type(FieldType::TextInput {
                placeholder: Some("DefaultGameMode".into()),
                multiline: false,
            }),
        )
        .setting(
            "max_entities",
            SchemaEntry::new(
                "Maximum entity count the ECS world will pre-allocate",
                65536_i64,
            )
            .label("Max Entities")
            .page("Gameplay")
        ...
        .setting(
            "random_seed",
            SchemaEntry::new(
                "RNG seed used for reproducible simulations (0 = random each launch)",
                0_i64,
            )
            .label("Random Seed")
            .page("Gameplay")
        ...
        .setting(
            ...
            SchemaEntry::new("Class name of the default player pawn", "DefaultPawn")
                .label("Default Player Class")
                .page("Gameplay")
                .field_type(FieldType::TextInput {
                    placeholder: Some("DefaultPawn".into()),
                    multiline: false,
                }),
        )
        .setting(
            ...
            SchemaEntry::new(
                "Class name of the default player controller",
                "PlayerController",
            )
            .label("Default Controller Class")
            .page("Gameplay")
            .field_type(FieldType::TextInput {
                placeholder: Some("PlayerController".into()),
                multiline: false,
            }),
        )
        .setting(
            ...
            SchemaEntry::new("Class name of the HUD to spawn for each player", "HUD")
                .label("Default HUD Class")
                .page("Gameplay")
                .field_type(FieldType::TextInput {
                    placeholder: Some("HUD".into()),
                    multiline: false,
                }),
        )
        .setting(
            ...
            SchemaEntry::new(
                "Seconds between a player dying and being allowed to respawn",
                3.0_f64,
            )
        ...
        .setting(
            ...
            SchemaEntry::new(
                "Respawn players at the last activated checkpoint instead of world start",
                true,
            )
        ...
        .setting(
            "allow_spectating",
            SchemaEntry::new(
                "Allow players to spectate after dying instead of waiting at a screen",
                true,
            )
            .label("Allow Spectating")
            .page("Gameplay")
            .field_type(FieldType::Checkbox),
        )
        .setting(
            "warmup_time_seconds",
            SchemaEntry::new(
                "Pre-match warmup period before the game begins in seconds (0 = skip)",
                0.0_f64,
            )
            .label("Warmup Time (s)")
            .page("Gameplay")
        ...
        .setting(
            "auto_save_enabled",
            SchemaEntry::new(
                "Automatically save the game at checkpoints and intervals",
                true,
            )
            .label("Auto Save")
            .page("Gameplay")
        ...
        .setting(
            ...
            SchemaEntry::new(
                "How often the game auto-saves in seconds (0 = checkpoint-only)",
                300_i64,
            )
        ...
        .setting(
            "physics_interaction_enabled",
            SchemaEntry::new(
                "Allow player characters to physically interact with the environment",
                true,
            )
            .label("Physics Interaction")
            .page("Gameplay")
            .field_type(FieldType::Checkbox),
        )
        .setting(
            "objective_markers_enabled",
