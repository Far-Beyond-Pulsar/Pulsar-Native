...
pub fn register(cfg: &'static ConfigManager) {
    let schema = NamespaceSchema::new("Graphics", "Real-time graphics feature toggles and quality")
        ...
        .setting(
            "max_fps",
            SchemaEntry::new(
                "Maximum frames per second the game will render (0 = unlimited)",
                0_i64,
            )
            .label("Max FPS")
            .page("Graphics")
        ...
        .setting(
            "lod_bias",
            SchemaEntry::new(
                "Bias applied to LOD selection distance (negative = higher quality)",
                0.0_f64,
            )
            .label("LOD Bias")
            .page("Graphics")
        ...
        .setting(
            "mip_bias",
            SchemaEntry::new(
                "Global mipmap bias (-ve = sharper, +ve = blurrier)",
                0.0_f64,
            )
            .label("Mip Bias")
            .page("Graphics")
        ...
        .setting(
            "decal_quality",
            SchemaEntry::new(
                "Quality and maximum count of projected decals in the scene",
                "medium",
            )
            .label("Decal Quality")
            .page("Graphics")
        ...
        .setting(
            "foliage_density",
            SchemaEntry::new(
                "Scale factor for foliage instance density (lower to improve performance)",
                1.0_f64,
            )
        ...
        .setting(
            "terrain_tesselation",
            SchemaEntry::new(
                "Enable GPU tessellation for terrain patches near the camera",
                false,
            )
            .label("Terrain Tessellation")
            .page("Graphics")
            .field_type(FieldType::Checkbox),
        )
        .setting(
        ...
        .setting(
            "max_lights",
            SchemaEntry::new(
                "Maximum number of dynamic lights affecting a single object",
                8_i64,
            )
            .label("Max Lights Per Object")
            .page("Graphics")
            .field_type(FieldType::NumberInput {
                min: Some(1.0),
                max: Some(32.0),
        ...
        .setting(
            "lens_flare",
            SchemaEntry::new(
                "Enable lens flare artifacts from bright light sources",
                false,
            )
            .label("Lens Flare")
            .page("Graphics")
        ...
        .setting(
            "chromatic_aberration",
            SchemaEntry::new(
                "Strength of chromatic aberration post-process effect at screen edges",
                0.0_f64,
            )
            .label("Chromatic Aberration")
            .page("Graphics")
        ...
        .setting(
            "vignette",
            SchemaEntry::new(
                "Intensity of screen-edge darkening vignette effect",
                0.0_f64,
            )
            .label("Vignette")
            .page("Graphics")
