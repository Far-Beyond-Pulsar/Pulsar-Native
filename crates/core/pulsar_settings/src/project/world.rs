...
pub fn register(cfg: &'static ConfigManager) {
    let schema = NamespaceSchema::new(
        "World",
        "World partition, streaming, and environment settings",
    )
    .setting(
    ...
    .setting(
        "streaming_distance",
        SchemaEntry::new(
            "Radius around the camera to stream in level content (m)",
            2000.0_f64,
        )
        .label("Streaming Distance (m)")
        .page("World")
        .field_type(FieldType::NumberInput {
            min: Some(100.0),
            max: Some(50000.0),
    ...
    .setting(
        "origin_rebasing",
        SchemaEntry::new(
            "Shift the world origin near the camera to prevent float precision issues",
            true,
        )
    ...
    .setting(
        "sun_angle",
        SchemaEntry::new(
            "Angle of the directional sun light (degrees from horizon)",
            45.0_f64,
        )
        .label("Sun Angle (°)")
        .page("World")
    ...
    .setting(
        "occlusion_culling",
        SchemaEntry::new(
            "Enable GPU-based occlusion culling for hidden geometry",
            true,
        )
    ...
    .setting(
        "time_of_day",
        SchemaEntry::new(
            "Current time of day in 24-hour decimal format (e.g. 14.5 = 14:30)",
            12.0_f64,
        )
        .label("Time of Day")
        .page("World")
    ...
    .setting(
        "day_length_minutes",
        SchemaEntry::new(
            "Duration of a full in-game day cycle in real-time minutes (0 = frozen)",
            0.0_f64,
        )
        .label("Day Length (real minutes)")
        .page("World")
        .field_type(FieldType::NumberInput {
            min: Some(0.0),
            max: Some(1440.0),
    ...
    .setting(
        "sun_azimuth",
        SchemaEntry::new(
            "Horizontal angle of the sun (degrees, 0 = North)",
            180.0_f64,
        )
        .label("Sun Azimuth (°)")
        .page("World")
    ...
    .setting(
        "wind_speed",
        SchemaEntry::new(
            "Wind speed for foliage and particle simulations (m/s)",
            3.0_f64,
        )
    ...
    .setting(
        "ambient_temperature",
        SchemaEntry::new(
            "Ambient temperature in Celsius used by environmental simulation",
            20.0_f64,
        )
        .label("Temperature (°C)")
        .page("World")
    ...
    .setting(
        "cloud_coverage",
        SchemaEntry::new(
            "Cloud coverage fraction for procedural sky (0.0 = clear, 1.0 = overcast)",
            0.3_f64,
        )
    ...
    .setting(
        "rain_intensity",
        SchemaEntry::new(
            "Rainfall intensity for the weather system (0 = none, 1 = heavy)",
            0.0_f64,
        )
    ...
    .setting(
        "ocean_level",
        SchemaEntry::new(
            "Height of the global ocean water plane in world units",
            0.0_f64,
        )
        .label("Ocean Level (m)")
        .page("World")
    ...
    .setting(
        ...
        SchemaEntry::new(
            "Play procedural ambient soundscape based on environment zone",
            true,
        )
