...
pub fn register(cfg: &'static ConfigManager) {
    let schema = NamespaceSchema::new(
        "Animation",
        "Skeletal animation and blend tree configuration",
    )
    .setting(
        "max_bones_per_mesh",
        SchemaEntry::new(
            "Maximum number of bones influencing a single skinned mesh",
            256_i64,
        )
        .label("Max Bones per Mesh")
        .page("Animation")
    ...
    .setting(
        "ik_iterations",
        SchemaEntry::new(
            "Maximum IK solver iterations per joint chain per frame",
            10_i64,
        )
        .label("IK Iterations")
        .page("Animation")
    ...
    .setting(
        "compression_quality",
        SchemaEntry::new(
            "Keyframe compression quality for stored animation clips",
            "medium",
        )
    ...
    .setting(
        "retargeting",
        SchemaEntry::new(
            "Enable animation retargeting between different skeleton rigs",
            true,
        )
    ...
    .setting(
        "update_rate_hz",
        SchemaEntry::new(
            "Animation graph evaluation rate in Hz (0 = every frame)",
            0_i64,
        )
        .label("Animation Update Rate (Hz)")
        .page("Animation")
        .field_type(FieldType::NumberInput {
            min: Some(0.0),
            max: Some(120.0),
    ...
    .setting(
        "animation_notify_budget_us",
        SchemaEntry::new(
            "CPU time budget per frame for animation notifies / events in microseconds",
            2000_i64,
        )
        .label("Notify Budget (\u{00b5}s)")
        .page("Animation")
        .field_type(FieldType::NumberInput {
            min: Some(100.0),
            max: Some(16000.0),
    ...
    .setting(
        "physics_animation_blend",
        SchemaEntry::new(
            "Blend between kinematic animation and physics simulation on ragdoll",
            1.0_f64,
        )
        .label("Physics Animation Blend")
        .page("Animation")
    ...
    .setting(
        ...
        SchemaEntry::new(
            "Enable procedural secondary motion for hair, clothing, and accessories",
            true,
        )
    ...
    .setting(
        "foot_ik",
        SchemaEntry::new(
            "Enable foot inverse kinematics to plant feet on uneven terrain",
            true,
        )
        .label("Foot IK")
        .page("Animation")
    ...
    .setting(
        "look_at",
        SchemaEntry::new(
            "Enable head/eye look-at constraint driven by target position",
            true,
        )
    ...
    .setting(
        ...
        SchemaEntry::new(
            "Default blend time for state machine transitions in seconds",
            0.2_f64,
        )
        .label("Default Blend Time (s)")
        .page("Animation")
        .field_type(FieldType::Slider {
            min: 0.0,
            max: 2.0,
    ...
    .setting(
        "additive_animation_enabled",
        SchemaEntry::new(
            "Support additive animation layers that modify a base pose",
            true,
        )
        .label("Additive Layers")
        .page("Animation")
        .field_type(FieldType::Checkbox),
    )
    .setting(
        "motion_matching",
        SchemaEntry::new(
            "Use motion matching instead of traditional state machines for locomotion",
            false,
        )
    ...
    .setting(
        "motion_matching_candidates",
        SchemaEntry::new(
            "Number of candidate poses evaluated per motion matching query",
            8_i64,
        )
        .label("MM Candidates")
        .page("Animation")
    ...
    .setting(
        "cloth_simulation",
        SchemaEntry::new(
            "Enable GPU cloth simulation for capes, robes, and flags",
            false,
        )
    ...
    .setting(
        "cloth_substeps",
        SchemaEntry::new(
            "Physics substeps per frame for cloth simulation accuracy",
            2_i64,
        )
        .label("Cloth Substeps")
        .page("Animation")
        .field_type(FieldType::NumberInput {
            min: Some(1.0),
            max: Some(8.0),
