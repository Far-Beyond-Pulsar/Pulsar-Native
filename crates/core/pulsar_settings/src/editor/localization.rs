...
pub fn register(cfg: &'static ConfigManager) {
    let schema = NamespaceSchema::new(
        "Localization (Editor)",
        "Editor language and regional settings",
    )
    .setting(
        "editor_language",
        SchemaEntry::new("Display language for the editor interface", "en")
            ...
            .field_type(FieldType::Dropdown {
                options: vec![
                    ...
                    DropdownOption::new("French (Canada)", "fr-CA"),
    ...
    .setting(
        "use_system_locale",
        SchemaEntry::new(
            "Inherit date, time, and number formats from the OS locale",
            true,
        )
    ...
    .setting(
        "spellcheck_enabled",
        SchemaEntry::new(
            "Enable spell-check in text input fields and the code editor",
            true,
        )
        .label("Spell Check")
        .page("Localization")
    ...
    .setting(
        "spellcheck_language",
        SchemaEntry::new(
            "Language code for the spell-check dictionary (empty = follow editor language)",
            "",
        )
        .label("Spell Check Language")
        .page("Localization")
        .field_type(FieldType::TextInput {
            placeholder: Some("en-US".into()),
            multiline: false,
        }),
    )
    .setting(
        "spellcheck_personal_dict",
        SchemaEntry::new("Path to a personal word list file for custom words", "")
            .label("Personal Dictionary")
            .page("Localization")
            .field_type(FieldType::TextInput {
                placeholder: Some("config/dictionary.txt".into()),
                multiline: false,
            }),
    )
    .setting(
        "spellcheck_in_comments",
        SchemaEntry::new("Run spell-check inside code comments", true)
            .label("Spell Check in Comments")
            .page("Localization")
            .field_type(FieldType::Checkbox),
    )
    .setting(
        "spellcheck_in_strings",
        SchemaEntry::new("Run spell-check inside string literals", false)
            .label("Spell Check in Strings")
            .page("Localization")
            .field_type(FieldType::Checkbox),
    )
    .setting(
        "rtl_ui_support",
        SchemaEntry::new(
            "Enable right-to-left layout mirroring for RTL languages",
            false,
        )
        .label("RTL UI Support")
        .page("Localization")
        .field_type(FieldType::Checkbox),
    )
    .setting(
        "pseudo_locale",
        SchemaEntry::new(
            "Replace all UI strings with decorated pseudo-locale text (for layout QA)",
            false,
        )
        .label("Pseudo-Locale")
        .page("Localization")
    ...
    .setting(
        "locale_override",
        SchemaEntry::new(
            "Force a specific locale code, overriding the editor language (empty = disabled)",
            "",
        )
