...
pub fn register(cfg: &'static ConfigManager) {
    let schema = NamespaceSchema::new("Keybindings", "Keyboard shortcut and keymap configuration")
        ...
        .setting(
            "custom_keymap_path",
            SchemaEntry::new(
                "Path to a custom keybindings JSON file (applied on top of preset)",
                "",
            )
            .label("Custom Keymap File")
            .page("Keybindings")
            .field_type(FieldType::TextInput {
                placeholder: Some("config/keybindings.json".into()),
                multiline: false,
            }),
        )
        .setting(
            "chord_timeout_ms",
            SchemaEntry::new(
                "Milliseconds to wait for the next key in a multi-key chord",
                500_i64,
            )
            .label("Chord Timeout (ms)")
            .page("Keybindings")
        ...
        .setting(
            "leader_key",
            SchemaEntry::new(
                "Key that starts leader-key sequences (leave blank to disable)",
                "",
            )
            .label("Leader Key")
            .page("Keybindings")
            .field_type(FieldType::TextInput {
                placeholder: Some("Space".into()),
                multiline: false,
            }),
        )
        .setting(
            "leader_timeout_ms",
            SchemaEntry::new(
                "Timeout after pressing the leader key before it is cancelled (ms)",
                1000_i64,
            )
        ...
        .setting(
            ...
            SchemaEntry::new(
                "Register OS-level global shortcuts active even when the editor is not focused",
                false,
            )
        ...
        .setting(
            "show_keybinding_hints",
            SchemaEntry::new(
                "Display keybinding hints next to menu items and buttons",
                true,
            )
        ...
        .setting(
            "vim_escape_key",
            SchemaEntry::new(
                "Key sequence to return to Normal mode in Vim emulation",
                "Escape",
            )
            .label("Vim Escape Key")
            .page("Vim")
            .field_type(FieldType::TextInput {
                placeholder: Some("Escape".into()),
                multiline: false,
            }),
        )
        .setting(
            "vim_ctrl_c_as_escape",
            SchemaEntry::new("Treat Ctrl+C as Escape in Vim emulation", true)
                .label("Ctrl+C as Escape")
                .page("Vim")
                .field_type(FieldType::Checkbox),
        )
        .setting(
            "vim_jk_escape",
            SchemaEntry::new(
                "Use 'jk' key sequence as an Escape alternative in insert mode",
                false,
            )
            .label("jk Escape")
            .page("Vim")
        ...
        .setting(
            ...
            SchemaEntry::new(
                "Allow mouse side-buttons (4 & 5) to be used as shortcut triggers",
                true,
            )
        ...
        .setting(
            "scroll_keybindings",
            SchemaEntry::new(
                "Allow scrolling via keyboard shortcuts (e.g. Page Up/Down in editors)",
                true,
            )
            .label("Scroll Keybindings")
            .page("Keybindings")
            .field_type(FieldType::Checkbox),
        )
        .setting(
            "viewport_wasd_mode",
            SchemaEntry::new(
                "Switch viewport navigation to WASD while right-mouse is held",
                true,
            )
            .label("Viewport WASD Mode")
            .page("Keybindings")
            .field_type(FieldType::Checkbox),
        )
        .setting(
            ...
            SchemaEntry::new(
                "Time window for recording a new shortcut before the dialog auto-closes (ms)",
                5000_i64,
            )
            .label("Record Timeout (ms)")
            .page("Keybindings")
            .field_type(FieldType::NumberInput {
                min: Some(1000.0),
                max: Some(30000.0),
        ...
        .setting(
            "allow_modifier_only_shortcuts",
            SchemaEntry::new(
                "Allow shortcuts that consist of modifier keys only (e.g. Shift+Ctrl)",
                false,
            )
            .label("Modifier-Only Shortcuts")
            .page("Keybindings")
            .field_type(FieldType::Checkbox),
        )
        .setting(
            "repeat_shortcuts_while_held",
            SchemaEntry::new(
                "Fire an action repeatedly while its shortcut key is held down",
                false,
            )
        ...
        .setting(
            ...
            SchemaEntry::new(
                "Delay before a held shortcut starts repeating (ms)",
                400_i64,
            )
        ...
        .setting(
            "shortcut_repeat_rate_ms",
            SchemaEntry::new(
                "Interval between repeated shortcut firings while held (ms)",
                50_i64,
            )
            .label("Repeat Rate (ms)")
            .page("Keybindings")
            .field_type(FieldType::NumberInput {
                min: Some(10.0),
                max: Some(500.0),
