//! Configuration management for Pulsar Relay Server
//!
...
/// Pulsar Relay Service Configuration
///
...
#[command(about = "Pulsar Relay — P2P rendezvous, relay, and signaling server")]
pub struct Cli {
