...
// ═════════════════════════════════════════════════════════════════════════════
// 14. Value integrity stress — data survives deep archetype migration
// ═════════════════════════════════════════════════════════════════════════════
...
fn stress_entity_slot_exhaustion() {
    ...
    // Phase 3: spawn new entities — should reuse freed slots with higher
    // generations.
...
// ═════════════════════════════════════════════════════════════════════════════
// 17.  Component variety — many types, large components, migration ordering
// ═════════════════════════════════════════════════════════════════════════════
...
fn stress_many_component_types() {
    ...
    // C1 is universal — all must be present.
...
fn stress_migration_column_reorder() {
    ...
    // Group 1: insert in Alpha → Beta → Gamma → Delta order.
    let mut g1 = Vec::new();
    for i in 0..20 {
        let e = world.spawn();
    ...
    // Group 2: insert in Delta → Gamma → Beta → Alpha order.
    let mut g2 = Vec::new();
    for i in 0..20 {
        let e = world.spawn();
        world.insert(e, Delta(i as f64 * 1000.0));
...
// ═════════════════════════════════════════════════════════════════════════════
// 18.  Bitmask correctness — 64+ component types
// ═════════════════════════════════════════════════════════════════════════════
...
// ═════════════════════════════════════════════════════════════════════════════
// 20.  Schedule stress — many systems and system ordering
// ═════════════════════════════════════════════════════════════════════════════
...
fn stress_schedule_mutate_components() {
    ...
    for run in 0..20 {
        ...
        // Odd runs: toggle is true → Value should be present
        // Even runs: toggle is false → Value should be absent
        if run % 2 == 0 {
...
fn stress_actor_mass_register_deregister() {
    ...
    // Deregister all actors (should also wipe their children? No — children
...
// ═════════════════════════════════════════════════════════════════════════════
// 22.  Chained removal — remove components in dependency order
// ═════════════════════════════════════════════════════════════════════════════
...
fn stress_dangling_entity_every_method() {
    ...
    // Insert panics (intentional — contract violation).
