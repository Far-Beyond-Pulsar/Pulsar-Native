// Comprehensive Criterion benchmark suite for pulsar_ecs.
//
// This file provides statistically rigorous benchmarks with:
// - Multiple entity scales (100 → 100K)
// - Multiple component counts (0 → 8 per entity)
...
fn query_tuple_size(c: &mut Criterion) {
    ...
    // Query with () — matches all archetypes, no data fetch.
...
fn query_selectivity(c: &mut Criterion) {
    ...
    for &n in &[10_000, 50_000] {
        ...
        // Query for (Pos, Health) — matches ~50% of entities.
        ...
        // Query for (Pos, Vel, Health) — matches ~25% of entities.
        ...
        // Query for () — matches 100% of entities, all archetypes.
...
// 5. CHURN BENCHMARKS
// =============================================================================
// Measures realistic entity lifecycle patterns: spawn → insert → query →
// remove → despawn → respawn.
//
// What it measures:
