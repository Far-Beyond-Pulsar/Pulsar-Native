...
///
/// Visual modifiers come from gpui_ce's [`Styled`] trait. Unlike a bare
...
///
/// 1. the instance style supplied through gpui_ce's [`Styled`] builder chain,
/// 2. value states such as `checked`, `pressed`, `selected`, or `focused`,
/// 3. `disabled`, which is always resolved last.
///
/// Semantic states therefore override the builder chain, matching how gpui_ce
