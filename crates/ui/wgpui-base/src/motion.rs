...
/// Matches gpui_ce's own default spring settling tolerance.
...
///
/// Call this while rendering an element, where gpui_ce keyed element state is
...
impl Spring {
    ...
    ///
    /// This is $\zeta$, not gpui_ce's `SpringConfig::damping`, which is the
    ...
    /// The physical parameters gpui_ce integrates. The response must be non-zero;
