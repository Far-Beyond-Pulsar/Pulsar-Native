...
/// popup content.
///
/// gpui_ce marks the active option on the option element itself rather than on the
...
mod tests {
    ...
    /// control. gpui_ce exposes no way to dispatch an accessibility action in a
