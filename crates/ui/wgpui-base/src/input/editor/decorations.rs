...
///
/// This is the gpui_ce [`HighlightStyle`] counterpart of Monaco's
...
impl TextDecoration {
    /// Create a text decoration from a UTF-8 byte range and a gpui_ce style.
...
///
/// This is the gpui_ce Component counterpart of Monaco's
