        ...
        for selection in state.selections.iter() {
            ...
            if is_active {
                ...
                if selection_changed && !is_selected_all {
                    ...
                    if !auto_scrolling {
                        // If we change the scroll_offset.y, gpui_ce will render and trigger the next run loop.
...
impl<M: InputModeKind> Element for TextElement<M> {
    ...
    fn prepaint(
        ...
        // #### text
        //
        // Hello 世界，this is gpui_ce component.
        // The gpui_ce Component is a collection of UI components for
        // gpui_ce framework, including Button, Input, Checkbox, Radio,
    ...
    fn paint(
        ...
        //
        // gpui_ce's `paint` only draws glyphs, underlines, and strikethroughs, so decoration
