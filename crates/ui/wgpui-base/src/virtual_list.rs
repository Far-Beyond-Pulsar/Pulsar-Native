...
//! https://github.com/zed-industries/zed/blob/0ae1603610ab6b265bdfbee7b8dbc23c5ab06edc/crates/gpui_ce/src/elements/uniform_list.rs
//!
...
///
/// This is like `uniform_list` in gpui_ce, but support two axis.
///
...
impl VirtualList {
    ...
    fn scroll_to_deferred_item(
        ...
        match scroll_to_item.strategy {
            ...
            _ => {
                // Ref: https://github.com/zed-industries/zed/blob/0d145289e0867a8d5d63e5e1397a5ca69c9d49c3/crates/gpui_ce/src/elements/div.rs#L3026
                if self.axis.is_vertical() {
    ...
    /// Ref from: https://github.com/zed-industries/zed/blob/83f9f9d9e3f5914392cab9a09e3472711a1d7b38/crates/gpui_ce/src/elements/uniform_list.rs#L660
    fn measure_item(
        &self,
