...
/// A gpui_ce element participating as one atomic object in a text line.
///
/// Use native gpui_ce styles, events and components on the element. TextView
/// measures its intrinsic size and wraps around the whole object. Fixed-width
/// elements keep their actual size; constrain them with gpui_ce styles as needed.
