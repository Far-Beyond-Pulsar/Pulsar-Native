...
/// Splits text into contiguous ranges sharing one font size. gpui_ce runs can
...
impl Inline {
    ...
    /// Preserve the shared inline-flow baseline through gpui_ce's element-bound snapping.
    ...
    fn layout_selections(
        ...
        // gpui_ce's content mask as before.
...
pub(super) mod test_draw {
    ...
    ///
    /// Measuring an inline object lays its gpui_ce element out through the
    /// window, which gpui_ce only permits while a frame is being drawn, so a test
