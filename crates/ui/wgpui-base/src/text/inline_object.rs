...
impl MeasuredInlineObject {
    /// Must run before entering a gpui_ce measured-layout callback: native element
    ...
    pub fn fit_text(mut self, width: Option<Pixels>) -> Self {
        // gpui_ce has no general subtree scale. Only our own plain-text fallback
...
/// Atomic selection wrapper that leaves child styling and interaction to gpui_ce.
