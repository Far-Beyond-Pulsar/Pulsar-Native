    ...
    items
        ...
        .map(|item| match item {
            MeasureItem::Object {
                ...
                // Must be the id `InlineObject` paints under: gpui_ce asserts a
...
/// Returns the line box and baseline from the shaped metrics used by gpui_ce text
    ...
    fn inline_code_size_is_relative_and_uses_the_native_body_baseline() {
        ...
        for body_size in [16., 20., 24.] {
            ...
            window.update(|_, window, cx| {
                ...
                // gpui_ce paints shaped lines with positive `LineLayout::descent`.
