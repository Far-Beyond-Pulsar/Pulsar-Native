...
/// used to display rich text in gpui_ce application (e.g., Help messages, Release notes)
...
impl TextView {
    ...
    ///
    /// The handler receives the resolved URL and the original gpui_ce click event.
...
mod tests {
    ...
    fn markdown_data_url_image_is_decoded_inline(cx: &mut TestAppContext) {
        ...
        assert!(
            ...
            "the data URL image must be handed to gpui_ce as decoded bytes",
        );
    }
