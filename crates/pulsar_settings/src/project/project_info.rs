    ...
    let schema = NamespaceSchema::new("Project", "Core project identity and metadata")
        ...
        .setting(
            ...
            SchemaEntry::new("Studio or company name shown in credits and metadata", "")
                ...
                .page("Project")
                .field_type(FieldType::TextInput {
                    placeholder: Some("Your Studio".into()),
                    multiline: false,
                }),
        )
        .setting(
            ...
            SchemaEntry::new("Short description of the game shown in metadata", "")
                ...
                .page("Project")
                .field_type(FieldType::TextInput {
                    placeholder: Some("A great game.".into()),
                    multiline: true,
                }),
        )
        .setting(
        ...
        .setting(
            ...
            SchemaEntry::new("Support or bug report URL", "")
                ...
                .page("Project")
                .field_type(FieldType::TextInput {
                    placeholder: Some("https://example.com/support".into()),
                    multiline: false,
                }),
        )
        .setting(
        ...
        .setting(
            ...
            SchemaEntry::new("Comma-separated genre/category tags", "")
                ...
                .page("Project")
                .field_type(FieldType::TextInput {
                    placeholder: Some("action, rpg, open-world".into()),
                    multiline: false,
                }),
        )
        .setting(
            "engine_version",
            SchemaEntry::new(
                "Minimum engine version required to open this project",
                "1.0.0",
            )
        ...
        .setting(
            "default_map",
            SchemaEntry::new(
                "Scene/map to load when the project starts",
                "scenes/default_level.json",
            )
            .label("Default Map")
            .page("Project")
            .field_type(FieldType::TextInput {
                placeholder: Some("scenes/default_level.json".into()),
                multiline: false,
            }),
        )
        .setting(
            "engine_version_min",
            SchemaEntry::new(
                "Minimum Pulsar engine version this project requires",
                "0.1.0",
            )
            .label("Min Engine Version")
            .page("Project")
        ...
        .setting(
            ...
            SchemaEntry::new("Copyright notice embedded in build metadata", "")
                ...
                .page("Project")
                .field_type(FieldType::TextInput {
                    placeholder: Some("Copyright 2025 My Studio".into()),
                    multiline: false,
                }),
        )
        .setting(
            "license_spdx",
            SchemaEntry::new(
                "SPDX license identifier for the project (e.g. MIT, Apache-2.0)",
                "",
            )
            .label("License (SPDX)")
            .page("Project")
            .field_type(FieldType::TextInput {
                placeholder: Some("MIT".into()),
                multiline: false,
            }),
        )
        .setting(
            ...
            SchemaEntry::new("URL for player support portal or bug tracker", "")
                ...
                .page("Project")
                .field_type(FieldType::TextInput {
                    placeholder: Some("https://support.example.com".into()),
                    multiline: false,
                }),
        )
        .setting(
            "privacy_policy_url",
            SchemaEntry::new(
                "URL of the project privacy policy shown at first launch",
                "",
            )
            .label("Privacy Policy URL")
            .page("Project")
            .field_type(FieldType::TextInput {
                placeholder: Some("https://example.com/privacy".into()),
                multiline: false,
            }),
        )
        .setting(
            "analytics_enabled",
            SchemaEntry::new(
                "Allow the game to collect and send anonymous gameplay analytics",
                false,
            )
            .label("Analytics")
            .page("Project")
        ...
        .setting(
            ...
            SchemaEntry::new(
                "Automatically capture and upload crash reports for debugging",
                true,
            )
        ...
        .setting(
            ...
            SchemaEntry::new("Endpoint URL where crash dumps are uploaded", "")
                .label("Crash Report URL")
                .page("Project")
                .field_type(FieldType::TextInput {
                    placeholder: Some("https://sentry.io/api/...".into()),
                    multiline: false,
                }),
        )
        .setting(
            "content_rating",
            SchemaEntry::new(
                "Official content rating for distribution platforms",
                "unrated",
            )
