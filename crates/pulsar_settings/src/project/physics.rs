...
pub fn register(cfg: &'static ConfigManager) {
    let schema = NamespaceSchema::new("Physics", "Physics engine configuration")
        ...
        .setting(
            "gravity_scale",
            SchemaEntry::new(
                "Global multiplier applied to all gravitational forces",
                1.0_f64,
            )
            .label("Gravity Scale")
            .page("Physics")
        ...
        .setting(
            "default_friction",
            SchemaEntry::new(
                "Default surface friction coefficient for new colliders",
                0.5_f64,
            )
        ...
        .setting(
            "solver_iterations_velocity",
            SchemaEntry::new(
                "Velocity constraint solver iterations per physics step",
                8_i64,
            )
            .label("Velocity Solver Iterations")
            .page("Physics")
            .field_type(FieldType::NumberInput {
                min: Some(1.0),
                max: Some(64.0),
        ...
        .setting(
            "solver_iterations_position",
            SchemaEntry::new(
                "Position constraint solver iterations per physics step",
                2_i64,
            )
            .label("Position Solver Iterations")
            .page("Physics")
            .field_type(FieldType::NumberInput {
                min: Some(1.0),
                max: Some(16.0),
        ...
        .setting(
            ...
            .label("Continuous Collision Detection (CCD)")
            .page("Physics")
            .field_type(FieldType::Checkbox),
        )
        .setting(
            ...
            SchemaEntry::new(
                "Kinetic energy threshold below which a rigid body enters sleep state",
                0.005_f64,
            )
        ...
        .setting(
            "contact_offset",
            SchemaEntry::new(
                "Distance at which contact points are generated (slightly above surface)",
                0.02_f64,
            )
        ...
        .setting(
            "water_physics",
            SchemaEntry::new(
                "Enable buoyancy and drag simulation for objects in water volumes",
                false,
            )
            .label("Water Physics")
            .page("Physics")
        ...
        .setting(
            "destruction_enabled",
            SchemaEntry::new(
                "Enable procedural mesh destruction / fracturing simulation",
                false,
            )
            .label("Destruction System")
            .page("Physics")
            .field_type(FieldType::Checkbox),
        )
        .setting(
            "max_destruction_chunks",
            SchemaEntry::new(
                "Maximum live chunk actors from destruction events before oldest are removed",
                256_i64,
            )
            .label("Max Destruction Chunks")
            .page("Physics")
            .field_type(FieldType::NumberInput {
                min: Some(16.0),
                max: Some(4096.0),
        ...
        .setting(
            "debug_draw_contacts",
            SchemaEntry::new(
                "Visualize active physics contact points in the editor viewport",
                false,
            )
            .label("Debug Draw Contacts")
            .page("Physics")
            .field_type(FieldType::Checkbox),
        )
        .setting(
            "debug_draw_joints",
            SchemaEntry::new(
                "Visualize physics constraint joints in the editor viewport",
                false,
            )
            .label("Debug Draw Joints")
            .page("Physics")
            .field_type(FieldType::Checkbox),
        );
