...
pub fn register(cfg: &'static ConfigManager) {
    let schema = NamespaceSchema::new("Window", "Game window presentation settings")
        ...
        .setting(
            "always_on_top",
            SchemaEntry::new(
                "Force the game window to always stay on top of other windows",
                false,
            )
            .label("Always On Top")
            .page("Window")
        ...
        .setting(
            "icon",
            SchemaEntry::new(
                "Path to the window icon image (.png or .ico)",
                "assets/icon.png",
            )
            .label("Window Icon")
            .page("Window")
            .field_type(FieldType::TextInput {
                placeholder: Some("assets/icon.png".into()),
                multiline: false,
            }),
        )
        .setting(
        ...
        .setting(
            "target_fps",
            SchemaEntry::new(
                "Target frame rate cap for the game window (0 = uncapped)",
                60_i64,
            )
            .label("Target FPS")
            .page("Window")
        ...
        .setting(
            ...
            SchemaEntry::new("Peak brightness for HDR output in nits", 1000.0_f64)
                .label("HDR Peak Brightness (nits)")
                .page("Window")
                .field_type(FieldType::NumberInput {
                    min: Some(400.0),
                    max: Some(10000.0),
        ...
        .setting(
            ...
            SchemaEntry::new(
                "Internal render resolution scale relative to the window size (1.0 = native)",
                1.0_f64,
            )
            .label("Render Scale")
            .page("Window")
        ...
        .setting(
            "dynamic_resolution",
            SchemaEntry::new(
                "Dynamically adjust render scale to maintain the target frame rate",
                false,
            )
        ...
        .setting(
            ...
            SchemaEntry::new(
                "FPS target that dynamic resolution scaling tries to maintain",
                60_i64,
            )
            .label("Dynamic Resolution Target FPS")
            .page("Window")
            .field_type(FieldType::NumberInput {
                min: Some(20.0),
                max: Some(240.0),
        ...
        .setting(
            "window_title",
            SchemaEntry::new(
                "Custom window title override (empty = use project name)",
                "",
            )
            .label("Window Title Override")
            .page("Window")
            .field_type(FieldType::TextInput {
                placeholder: Some("My Game".into()),
                multiline: false,
