...
pub fn register(cfg: &'static ConfigManager) {
    let schema = NamespaceSchema::new("AI", "Artificial intelligence and navigation settings")
        ...
        .setting(
            "navmesh_cell_size",
            SchemaEntry::new(
                "Navmesh voxel cell size (m) — smaller = more detail, more memory",
                0.3_f64,
            )
            .label("Cell Size (m)")
            .page("AI")
        ...
        .setting(
            "pathfinding_budget_us",
            SchemaEntry::new(
                "CPU budget for pathfinding per frame in microseconds",
                1000_i64,
            )
            .label("Pathfinding Budget (µs)")
            .page("AI")
            .field_type(FieldType::NumberInput {
                min: Some(100.0),
                max: Some(16000.0),
        ...
        .setting(
            "behavior_tree_tick_hz",
            SchemaEntry::new(
                "How many times per second behavior trees are evaluated",
                10_i64,
            )
            .label("Behavior Tree Tick (Hz)")
            .page("AI")
            .field_type(FieldType::NumberInput {
                min: Some(1.0),
                max: Some(60.0),
        ...
        .setting(
            "debug_navmesh",
            SchemaEntry::new(
                "Overlay navmesh visualization in the editor viewport",
                false,
            )
            .label("Debug Navmesh")
            .page("AI")
        ...
        .setting(
            "max_crowd_agents",
            SchemaEntry::new(
                "Maximum number of agents that participate in crowd simulation simultaneously",
                128_i64,
            )
            .label("Max Crowd Agents")
            .page("AI")
            .field_type(FieldType::NumberInput {
                min: Some(8.0),
                max: Some(4096.0),
        ...
        .setting(
            "avoidance_algorithm",
            SchemaEntry::new(
                "Local avoidance algorithm for agents avoiding each other",
                "rvo2",
            )
        ...
        .setting(
            "navmesh_auto_rebuild",
            SchemaEntry::new(
                "Rebuild the navmesh automatically when level geometry changes",
                true,
            )
            .label("Auto-Rebuild Navmesh")
            .page("AI")
            .field_type(FieldType::Checkbox),
        )
        .setting(
            "navmesh_build_threads",
            SchemaEntry::new(
                "Number of threads used for background navmesh building (0 = auto)",
                0_i64,
            )
            .label("Navmesh Build Threads")
            .page("AI")
            .field_type(FieldType::NumberInput {
                min: Some(0.0),
                max: Some(32.0),
        ...
        .setting(
            "navmesh_tile_size",
            SchemaEntry::new(
                "NavMesh tile size in world units (larger = fewer tiles, less granularity)",
                128_i64,
            )
            .label("Navmesh Tile Size")
            .page("AI")
            .field_type(FieldType::NumberInput {
                min: Some(16.0),
                max: Some(2048.0),
        ...
        .setting(
            "steering_force",
            SchemaEntry::new(
                "Magnitude of the steering force applied per frame to guide agents",
                1.0_f64,
            )
        ...
        .setting(
            ...
            SchemaEntry::new(
                "Maximum turning speed for agents in degrees per second",
                360.0_f64,
            )
            .label("Max Turn Speed (°/s)")
            .page("AI")
            .field_type(FieldType::NumberInput {
                min: Some(10.0),
                max: Some(1080.0),
        ...
        .setting(
            ...
            SchemaEntry::new(
                "Interval between line-of-sight checks for perception in milliseconds",
                100_i64,
            )
            .label("LoS Check Interval (ms)")
            .page("AI")
            .field_type(FieldType::NumberInput {
                min: Some(16.0),
                max: Some(1000.0),
        ...
        .setting(
            "forget_time_seconds",
            SchemaEntry::new(
                "Time in seconds before an AI loses track of a stimulus it can no longer detect",
                5.0_f64,
            )
            .label("Forget Time (s)")
            .page("AI")
