...
pub fn register(cfg: &'static ConfigManager) {
    let schema = NamespaceSchema::new("Input", "Player input and control settings")
        ...
        .setting(
            "raw_mouse_input",
            SchemaEntry::new(
                "Use raw device mouse input, bypassing OS acceleration",
                true,
            )
        ...
        .setting(
            "gamepad_dead_zone",
            SchemaEntry::new(
                "Radial dead zone for analog sticks (0.0 = none, 0.2 = typical)",
                0.1_f64,
            )
        ...
        .setting(
            ...
            SchemaEntry::new(
                "Analog trigger threshold below which the trigger is considered released",
                0.1_f64,
            )
        ...
        .setting(
            "gyroscope_aim",
            SchemaEntry::new(
                "Use controller gyroscope / accelerometer for additional aiming precision",
                false,
            )
            .label("Gyroscope Aim")
            .page("Input")
        ...
        .setting(
            "raw_mouse_input",
            SchemaEntry::new(
                "Bypass OS cursor acceleration and use raw hardware mouse data",
                true,
            )
            .label("Raw Mouse Input")
            .page("Input")
        ...
        .setting(
            "pointer_smoothing",
            SchemaEntry::new(
                "Number of frames over which pointer input is averaged for smoothing (1 = off)",
                1_i64,
            )
            .label("Pointer Smoothing Frames")
            .page("Input")
            .field_type(FieldType::NumberInput {
                min: Some(1.0),
                max: Some(8.0),
        ...
        .setting(
            "input_action_bindings_file",
            SchemaEntry::new(
                "Path to the project's input action bindings JSON",
                "config/input_actions.json",
            )
            .label("Action Bindings File")
            .page("Input")
            .field_type(FieldType::TextInput {
                placeholder: Some("config/input_actions.json".into()),
                multiline: false,
            }),
        );
