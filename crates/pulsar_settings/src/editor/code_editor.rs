...
pub fn register(cfg: &'static ConfigManager) {
    let schema = NamespaceSchema::new("Code Editor", "Source code editing behavior and display")
        ...
        .setting(
            ...
            SchemaEntry::new("Font family for source code", "JetBrains Mono")
                ...
                .field_type(FieldType::TextInput {
                    placeholder: Some("JetBrains Mono".into()),
                    multiline: false,
                }),
        )
        .setting(
        ...
        .setting(
            "word_wrap_column",
            SchemaEntry::new(
                "Column at which to wrap lines when word wrap is 'bounded'",
                120_i64,
            )
            .label("Wrap Column")
            .page("Code Editor")
        ...
        .setting(
            "auto_save",
            SchemaEntry::new(
                "Automatically save files when focus is lost or editor is idle",
                true,
            )
            .label("Auto Save")
            .page("Code Editor")
        ...
        .setting(
            "rulers",
            SchemaEntry::new(
                "Comma-separated column positions to draw vertical rulers",
                "",
            )
            .label("Column Rulers")
            .page("Code Editor")
            .field_type(FieldType::TextInput {
                placeholder: Some("80, 120".into()),
                multiline: false,
            }),
        )
        ...
        .setting(
            ...
            SchemaEntry::new(
                "Show completion suggestions when trigger characters are typed",
                true,
            )
            .label("Suggest on Trigger")
            .page("Code Editor")
            .field_type(FieldType::Checkbox),
        )
        .setting(
        ...
        .setting(
            "snippet_suggestions",
            SchemaEntry::new(
                "How to handle snippet completions in the suggestion list",
                "inline",
            )
