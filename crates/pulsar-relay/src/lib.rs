//! # Pulsar Relay - P2P rendezvous, relay, and signaling server
//!
...
//! - **Persistence** - PostgreSQL for session snapshots
//!
//! ## Architecture
//!
...
//! cargo run --bin pulsar-relay -- --http-bind 0.0.0.0:8080 --log-level debug
//! ```
//!
//! ## Module Overview
//!
