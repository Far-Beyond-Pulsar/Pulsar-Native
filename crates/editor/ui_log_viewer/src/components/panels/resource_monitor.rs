...
impl Render for ResourceMonitorPanel {
    fn render(&mut self, _window: &mut Window, cx: &mut Context<Self>) -> impl IntoElement {
        use ui::{chart::AreaChart, h_flex, scroll::ScrollbarAxis};
        ...
        v_flex()
            ...
            .child(Self::io_chart_card(
                ...
                net_rx_data,
                |d: &crate::utils::performance_metrics::NetDataPoint| d.kbps,
                theme.info,
                cx,
            ))
            .child(Self::io_chart_card(
            ...
            .child(Self::io_chart_card(
                ...
                disk_read_data,
                |d: &crate::utils::performance_metrics::DiskDataPoint| d.kbps,
                theme.success,
                cx,
            ))
            .child(Self::io_chart_card(
