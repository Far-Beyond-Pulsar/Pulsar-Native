...
pub struct PerformanceMetrics {
    ...
    pub mem_snapshot: crate::utils::mem_details::MemorySnapshot,
...
impl PerformanceMetrics {
    ...
    fn build(
        ...
        Self {
            ...
            mem_snapshot: crate::utils::mem_details::MemorySnapshot::default(),
    ...
    pub fn update_system_metrics(&mut self) {
        ...
        self.mem_snapshot = crate::utils::mem_details::collect(&self.system);
        ...
        let engine_map = crate::utils::gpu_engines::collect();
        ...
        if !engine_map.is_empty() {
            for &eng in crate::utils::gpu_engines::KNOWN_ENGINES {
