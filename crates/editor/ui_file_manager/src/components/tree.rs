...
use crate::utils::{tree::FolderNode, types::*};
...
impl FileManagerDrawer {
        ...
        v_flex()
            ...
            .child(
                v_flex()
                    ...
                    .child(
                        div().w_full().child(
                            TextInput::new(&self.folder_search_state).w_full().prefix(
                    ...
                    .when_some(self.folder_tree.clone(), |this, tree| {
                        this.child(
                            v_flex()
                                ...
                                .child(self.render_folder_node(&tree, 0, w, cx)),
                        )
                    })
    ...
    pub fn render_folder_node(
        ...
        let sel = self.selected_folder.as_ref() == Some(&node.path);
        ...
        v_flex()
            ...
            .children(if exp {
                node.children
                    .iter()
                    .map(|c| {
                        self.render_folder_node(c, depth + 1, w, cx)
                            .into_any_element()
                    })
                    .collect()
            } else {
