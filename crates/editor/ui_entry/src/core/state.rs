...
impl InputEntities {
    ...
    pub fn subscribe_all(&self, screen: WeakEntity<crate::screen::EntryScreen>, cx: &mut App) {
...
pub struct AppState {
    ...
    pub(crate) git_fetch_task: Option<Task<()>>,
