...
const ENTRIES: &[Entry] = &[
    ...
    Entry { id: "opencode_go", display_name: "OpenCode Go", kind: ProviderKind::Cloud, endpoint: Some("https://opencode.ai/go/v1"), use_ollama_protocol: false, chat_path: Some("/chat/completions") },
    Entry { id: "opencode_zen", display_name: "OpenCode Zen", kind: ProviderKind::Cloud, endpoint: Some("https://opencode.ai/zen/v1"), use_ollama_protocol: false, chat_path: Some("/chat/completions") },
