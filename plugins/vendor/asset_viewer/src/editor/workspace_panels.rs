...
impl Render for AssetPropertiesPanel {
    fn render(&mut self, window: &mut Window, cx: &mut Context<Self>) -> impl IntoElement {
        ...
        div()
            ...
            .p_3()
            .child(v_flex().gap_4()
                .child(section(cx, t!("AssetViewer.File").as_ref(), div().text_sm().child(file_name)))
                .child(section(cx, t!("AssetViewer.Info").as_ref(), div().text_sm().child(dims)))
                .child(section(cx, t!("AssetViewer.History").as_ref(), h_flex().gap_2()
                    .child(ghost_btn(t!("AssetViewer.Undo").as_ref()).when(!has_undo, |b| b.disabled(true))
                        .on_mouse_down(MouseButton::Left, {
                            let ew = ew.clone();
                            move |_ev, _window, cx| { ew.clone().update(cx, |e, _cx| e.undo()); }
                        }))
                    .child(ghost_btn(t!("AssetViewer.Redo").as_ref()).when(!has_redo, |b| b.disabled(true))
                        .on_mouse_down(MouseButton::Left, {
                            let ew = ew.clone();
                            move |_ev, _window, cx| { ew.clone().update(cx, |e, _cx| e.redo()); }
                        }))
                    .child(primary_btn(t!("AssetViewer.Save").as_ref())
                        .on_mouse_down(MouseButton::Left, {
                            let ew = ew.clone();
                            move |_ev, _window, cx| {
                ...
                .child(section(cx, t!("AssetViewer.Transform").as_ref(), h_flex().gap_2()
                    .child(ghost_btn(t!("AssetViewer.RotCW").as_ref())
                        .on_mouse_down(MouseButton::Left, {
                            let ew = ew.clone();
                            move |_ev, _window, cx| { ew.clone().update(cx, |e, _cx| e.rotate_90()); }
                        }))
                    .child(ghost_btn(t!("AssetViewer.RotCCW").as_ref())
                        .on_mouse_down(MouseButton::Left, {
                            let ew = ew.clone();
                            move |_ev, _window, cx| { ew.clone().update(cx, |e, _cx| e.rotate_ccw()); }
                        }))
                    .child(ghost_btn(t!("AssetViewer.FlipH").as_ref())
                        .on_mouse_down(MouseButton::Left, {
                            let ew = ew.clone();
                            move |_ev, _window, cx| { ew.clone().update(cx, |e, _cx| e.flip_h()); }
                        }))
                    .child(ghost_btn(t!("AssetViewer.FlipV").as_ref())
                        .on_mouse_down(MouseButton::Left, {
                            let ew = ew.clone();
                            move |_ev, _window, cx| { ew.clone().update(cx, |e, _cx| e.flip_v()); }
                        }))
                ))
                .child(section(cx, t!("AssetViewer.Adjust").as_ref(), v_flex().gap_2()
                    .child(ghost_btn(t!("AssetViewer.Grayscale").as_ref())
                        .on_mouse_down(MouseButton::Left, {
                            let ew = ew.clone();
                            move |_ev, _window, cx| { ew.clone().update(cx, |e, _cx| e.grayscale()); }
                        }))
                    .child(ghost_btn(t!("AssetViewer.InvertColors").as_ref())
                        .on_mouse_down(MouseButton::Left, {
                            let ew = ew.clone();
                            move |_ev, _window, cx| { ew.clone().update(cx, |e, _cx| e.invert()); }
                        }))
                    .child(h_flex().gap_2()
                        .child(ghost_btn(t!("AssetViewer.BrightnessUp").as_ref())
                            .on_mouse_down(MouseButton::Left, {
                                let ew = ew.clone();
                                move |_ev, _window, cx| { ew.clone().update(cx, |e, _cx| e.adjust_brightness(20)); }
                            }))
                        .child(ghost_btn(t!("AssetViewer.BrightnessDown").as_ref())
                            .on_mouse_down(MouseButton::Left, {
                                let ew = ew.clone();
                                move |_ev, _window, cx| { ew.clone().update(cx, |e, _cx| e.adjust_brightness(-20)); }
                            }))
                    ...
                    .child(h_flex().gap_2()
                        .child(ghost_btn(t!("AssetViewer.ContrastUp").as_ref())
                            .on_mouse_down(MouseButton::Left, {
                                let ew = ew.clone();
                                move |_ev, _window, cx| { ew.clone().update(cx, |e, _cx| e.adjust_contrast(1.3)); }
                            }))
                        .child(ghost_btn(t!("AssetViewer.ContrastDown").as_ref())
                            .on_mouse_down(MouseButton::Left, {
                                let ew = ew.clone();
                ...
                .child(section(cx, t!("AssetViewer.View").as_ref(),
                    ghost_btn(t!("AssetViewer.ResetZoom").as_ref())
                        .on_mouse_down(MouseButton::Left, {
                            let ew = ew.clone();
...
fn render_3d_table(cx: &mut App, file_name: &str, ew: &Entity<AssetViewerPanel>) -> AnyElement {
    ...
    div()
        ...
        .p_3()
        .child(v_flex().gap_4()
            .child(section(cx, t!("AssetViewer.File").as_ref(), v_flex().gap_1()
                .child(div().text_sm().child(file_name.to_string()))
            ))
            .child(section(cx, t!("AssetViewer.Scene").as_ref(), v_flex().gap_1()
                .child(stat_row(cx, t!("AssetViewer.Meshes").as_ref(), &stats.mesh_count.to_string()))
                .child(stat_row(cx, t!("AssetViewer.Vertices").as_ref(), &stats.total_vertices.to_string()))
                .child(stat_row(cx, t!("AssetViewer.Triangles").as_ref(), &(stats.total_indices / 3).to_string()))
                .child(stat_row(cx, t!("AssetViewer.Materials").as_ref(), &stats.material_count.to_string()))
                .when(!stats.generator.is_empty(), |el| el.child(stat_row(cx, t!("AssetViewer.Generator").as_ref(), &stats.generator)))
            ))
            .child(section(cx, t!("AssetViewer.Resources").as_ref(), v_flex().gap_1()
                .child(stat_row(cx, t!("AssetViewer.Textures").as_ref(), &stats.texture_count.to_string()))
                .child(stat_row(cx, t!("AssetViewer.Images").as_ref(), &stats.image_count.to_string()))
                .child(stat_row(cx, t!("AssetViewer.Lights").as_ref(), &stats.light_count.to_string()))
                .child(stat_row(cx, t!("AssetViewer.Cameras").as_ref(), &stats.camera_count.to_string()))
            ))
            .child(section(cx, t!("AssetViewer.Animation").as_ref(), v_flex().gap_1()
                .child(stat_row(cx, t!("AssetViewer.Clips").as_ref(), &stats.animation_count.to_string()))
                .child(stat_row(cx, t!("AssetViewer.Skins").as_ref(), &stats.skin_count.to_string()))
                .child(stat_row(cx, t!("AssetViewer.Joints").as_ref(), &stats.total_joints.to_string()))
                .child(stat_row(cx, t!("AssetViewer.MorphTargets").as_ref(), &stats.morph_target_count.to_string()))
            ))
            .when(!props.is_empty(), |el| el.child(
                section(cx, t!("AssetViewer.Meshes").as_ref(), v_flex().gap_1()
                    .child(h_flex().gap_1().py_1().text_xs().text_color(cx.theme().muted_foreground)
                        .child(hdr(t!("AssetViewer.ColName").as_ref())).child(hdr(t!("AssetViewer.ColVerts").as_ref())).child(hdr(t!("AssetViewer.ColTris").as_ref()))
                        .child(hdr(t!("AssetViewer.ColN").as_ref())).child(hdr(t!("AssetViewer.ColT").as_ref())).child(hdr(t!("AssetViewer.ColUV").as_ref())).child(hdr(t!("AssetViewer.ColC").as_ref()))
